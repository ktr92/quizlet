<template>
  <div
    class="bg-white border-gray-200 px-4 lg:px-6 py-2 dark:bg-gray-900 relative"
  >
    <div class="max-w-[1200px] mx-auto py-2">
      <nav class="">
        ...
        >
            ...
            <div v-else class="flex items-center">
              ...
              >
                <div class="flex items-center">
                  ...
                  />
                  <span class="ml-2 text-sm leading-4">{{
          ...
          <div
            class="absolute top-[100%] left-0 justify-between items-center w-full lg:flex lg:w-auto lg:order-1 bg-white dark:bg-primary-800 pb-4 px-2"
            id="mobile-menu-2"
            v-if="menuexpanded"
          >
            <ul
